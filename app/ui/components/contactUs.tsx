...
export default function ContactUsSection() {
  return (
    <>
      ...
      <div className="relative flex bg-[#0D476D] p-7 m-4 rounded-[7.28px]">
        <div>
          <h1 className={`${urbanist.className} font-[500] text-[#FFFFFF] mb-4`}>
            Interested in joining our <br /> team? Contact us <br />  today!
          </h1>

          <button
            type="button"
            style={{ boxShadow: "0px 0px 15px 0px #0000001A" }}
            className={`${montserrat.className} text-[7px] font-[700] flex items-center gap-2 focus:outline-none text-white bg-[#092D48] hover:bg-green-800 focus:ring-4 focus:ring-green-300 rounded-lg text-sm px-3 py-1 me-2 mb-2`}
          >
            Contact Us
            <svg
              width="6"
        ...
        <div className="flex">
          <Image
             className="absolute bottom-0.5 right-0.5 w-[200px]"
             src={Robat}
             alt="logo"
             sizes="100vw"
          />
